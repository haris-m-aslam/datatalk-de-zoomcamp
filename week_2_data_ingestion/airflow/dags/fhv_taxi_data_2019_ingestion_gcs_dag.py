...
# https://nyc-tlc.s3.amazonaws.com/trip+data/fhv_tripdata_2020-03.csv
...
with DAG(
    dag_id="fhv_taxi_data_2019_ingestion_gcs_dag",
    ...
    # download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> bigquery_external_table_task >> remove_file_task
